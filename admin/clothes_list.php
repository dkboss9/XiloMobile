...
$result=mysqli_query($connection,"select product_id,image, product_name,price from products  where product_type like '%dress%' order by time Desc Limit $page1,10")or die ("query 1 incorrect.....");
